...
with open("mobiles.csv","w") as f:              #for writing header to CSV file
    writer=csv.writer(f)
    writer.writerow(["NAME", "PRICE", "RATING"])

for i in range(1,4):        #iterating for first 3 pages
    url='https://www.flipkart.com/search?q=mobiles&otracker=search&otracker1=search&marketplace=FLIPKART&as-show=on&as=off&page='+str(i)        #taking urls of pages while iterating
    ...
    for j in soup.findAll('a', href=True, attrs={'class' : '_1fQZEK'}):     #iterating for all products on the page
    ...
    with open("mobiles.csv", "a") as f:             #for writing mobiles having rating more than or equal to 4.4
